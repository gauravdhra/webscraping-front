...
@Component({
  selector: 'app-jharkhand',
  templateUrl: './jharkhand.component.html',
  styleUrls: ['./jharkhand.component.scss']
})
export class JharkhandComponent implements OnInit {
selectedSearch = "party"
  baseUrl = environment.baseUrl+'/jharkhand'
  spinner = false
  headers = []
  listResponse = [];
