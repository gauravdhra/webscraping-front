...
@Component({
  ...
  templateUrl: './himachal-pradesh.component.html',
  styleUrls: ['./himachal-pradesh.component.scss']
})
export class HimachalPradeshComponent implements OnInit {
selectedSearch = "party"
  baseUrl = environment.baseUrl+'/himachal-pradesh'
  spinner = false
  headers = []
  listResponse = [];
